...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rotate.name'
        db.add_column(u'sysop_rotate', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=63, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Rotate.description'
        db.add_column(u'sysop_rotate', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rotate.name'
        db.delete_column(u'sysop_rotate', 'name')

        # Deleting field 'Rotate.description'
        db.delete_column(u'sysop_rotate', 'description')
