...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Domain'
        db.create_table(u'sysop_domain', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('domain', self.gf('django.db.models.fields.CharField')(max_length=253)),
        ))
        db.send_create_signal(u'sysop', ['Domain'])

        # Adding field 'Rotate.domain'
        db.add_column(u'sysop_rotate', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sysop.Domain'], null=True),
                      keep_default=False)

        # Adding field 'Server.domain'
        db.add_column(u'sysop_server', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sysop.Domain'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'sysop_domain')

        # Deleting field 'Rotate.domain'
        db.delete_column(u'sysop_rotate', 'domain_id')

        # Deleting field 'Server.domain'
        db.delete_column(u'sysop_server', 'domain_id')
    ...
    models = {
        ...
        u'sysop.rotate': {
            ...
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sysop.Domain']", 'null': 'True'}),
