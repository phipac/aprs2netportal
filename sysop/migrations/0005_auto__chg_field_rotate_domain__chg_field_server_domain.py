...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rotate.domain'
        db.alter_column(u'sysop_rotate', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sysop.Domain']))

        # Changing field 'Server.domain'
        db.alter_column(u'sysop_server', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sysop.Domain']))

    def backwards(self, orm):

        # Changing field 'Rotate.domain'
        db.alter_column(u'sysop_rotate', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sysop.Domain'], null=True))

        # Changing field 'Server.domain'
        db.alter_column(u'sysop_server', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sysop.Domain'], null=True))
