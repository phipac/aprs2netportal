...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReservedHostname'
        db.create_table(u'sysop_reservedhostname', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hostname', self.gf('django.db.models.fields.CharField')(max_length=63)),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sysop.Domain'])),
        ))
        db.send_create_signal(u'sysop', ['ReservedHostname'])


    def backwards(self, orm):
        # Deleting model 'ReservedHostname'
        db.delete_table(u'sysop_reservedhostname')
