...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Rotate.dns_name'
        db.rename_column(u'sysop_rotate', 'dns_name', 'hostname')

        # Renaming field 'Server.dns_name'
        db.rename_column(u'sysop_server', 'dns_name', 'hostname')


    def backwards(self, orm):
        # Renaming field 'Rotate.dns_name'
        db.rename_column(u'sysop_rotate', 'hostname', 'dns_name')

        # Renaming field 'Server.dns_name'
        db.rename_column(u'sysop_server', 'hostname', 'dns_name')
